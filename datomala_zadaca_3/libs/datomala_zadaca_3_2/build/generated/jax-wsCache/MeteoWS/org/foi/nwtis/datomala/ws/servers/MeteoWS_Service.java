 ...
 * 
 */
@WebServiceClient(name = "MeteoWS", targetNamespace = "http://servers.ws.datomala.nwtis.foi.org/", wsdlLocation = "http://localhost:8080/datomala_zadaca_3_1/MeteoWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/datomala_zadaca_3_1/MeteoWS?wsdl");
