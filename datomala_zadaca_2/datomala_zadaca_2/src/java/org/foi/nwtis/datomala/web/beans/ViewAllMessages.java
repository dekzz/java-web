...
import org.foi.nwtis.datomala.web.controls.MessageAttachment;
...
public class ViewAllMessages implements Serializable {
    ...
    private String[] directories = {"inbox",
                                    MessageProcessing.config.getSettings("nameValidDirectory"),
                                    MessageProcessing.config.getSettings("nameInvalidDirectory"),
                                    MessageProcessing.config.getSettings("nameOtherDirectory")};
    ...
    public String getEmailServer() {
        EmailConnection ec = (EmailConnection) FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("emailConnection");
        this.emailServer = ec.getEmailServer();
        return emailServer;
    }
